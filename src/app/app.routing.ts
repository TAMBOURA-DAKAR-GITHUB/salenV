...
export const routes: Routes = [
  ...
  {
    path:"modifierregion/:id", component:ModifierregionComponent

  },
  {
    path:"modifiercercle/:id", component:ModifiercercleComponent

  },
  {
    path:"modifiercommune/:id", component:ModifiercommuneComponent
